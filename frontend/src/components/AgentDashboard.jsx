    ...
    <div className="ag-root">
      ...
      <div className="ag-header">
        <div className="ag-header-left">
          ...
          <p className="ag-sub">
            CricAPI result polling · Live scores &amp; toss via /api/live-intel (RapidAPI + cache) · ML accuracy tracking
          </p>
        </div>
        ...
        <div className="ag-col-chart">
          ...
          <div className="ag-agent-status">
            ...
            <button className="ag-btn ag-btn--full" onClick={triggerNow} disabled={triggering}>
              ...
              {triggering ? "Polling CricAPI…" : "Trigger Manual Poll"}
            </button>
          </div>
        </div>
      </div>
